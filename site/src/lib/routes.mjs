...
// Semua path internal BER-trailing-slash — Cloudflare Pages menyajikan versi
// ber-slash sbg 200 (non-slash → 308). Konsisten agar klik internal tak kena
// redirect + canonical/hreflang benar. Lihat withSlash di Base.astro.
